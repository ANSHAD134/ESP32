...
void app_main(void)
{
    // Configure GPIO Pin 5 as an Input
    gpio_reset_pin(SWITCH_PIN);                      // Reset GPIO pin 5
    gpio_set_direction(SWITCH_PIN, GPIO_MODE_INPUT); // Set GPIO pin 5 as input
    gpio_pullup_en(SWITCH_PIN);                      // Enable pull-up resistor for GPIO pin 5
